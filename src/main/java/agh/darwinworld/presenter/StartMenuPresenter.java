    ...
    public void onSimulationStart(ActionEvent actionEvent) {
        ...
        try {
            ...
            SimulationParameters params = new SimulationParameters(
                    widthIntField.getValue(),
                    heightIntField.getValue(),
                    startingPlantAmountIntField.getValue(),
                    plantGrowingAmountIntField.getValue(),
                    plantEnergyAmountIntField.getValue(),
                    startingAnimalAmountIntField.getValue(),
                    startingEnergyAmountIntField.getValue(),
                    minimumBreedingEnergyIntField.getValue(),
                    breedingEnergyCostIntField.getValue(),
                    minimumMutationAmountIntField.getValue(),
                    maximumMutationAmountIntField.getValue(),
                    animalGenomeLengthIntField.getValue(),
                    fireFrequencyIntField.getValue(),
                    fireLengthIntField.getValue(),
                    refreshTimeIntField.getValue(),
